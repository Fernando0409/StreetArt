...
<<<<<<< HEAD
    <link rel="stylesheet" href="resources/css/styles_dibujo.css">
=======
    <link rel="stylesheet" href="/categorias/resources/css/styles_dibujo.css">
>>>>>>> master
...
<<<<<<< HEAD
        <?php
            $categoria = "";
            $query = "SELECT * FROM categorias WHERE categoria = 'dibujo'";
