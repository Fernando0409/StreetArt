...
<<<<<<< HEAD
    <link rel="stylesheet" href="resources/css/styles_pintura.css">
=======
    <link rel="stylesheet" href="/categorias/resources/css/styles_pintura.css">
>>>>>>> master
...
<<<<<<< HEAD
        <?php
            $categoria = "";
            $query = "SELECT * FROM categorias WHERE categoria = 'pintura'";
