...
<head>
    ...
    <link rel="stylesheet" href="resources/css/styles_animacion.css">

    <link rel="stylesheet" href="/categorias/resources/css/styles_animacion.css">
...
<body>
    ...
    ?>
        ...
        <?php
            $categoria = "";
            $query = "SELECT * FROM categorias WHERE categoria = 'animacion'";
