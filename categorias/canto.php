...
<<<<<<< HEAD
    <link rel="stylesheet" href="resources/css/styles_canto.css">
=======
    <link rel="stylesheet" href="/categorias/resources/css/styles_canto.css">
>>>>>>> master
...
<<<<<<< HEAD
                <?php
            $categoria = "";
            $query = "SELECT * FROM categorias WHERE categoria = 'canto'";
